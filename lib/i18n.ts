...
export const messages = {
  ro: {
    ...
    remindersNew: {
      ...
      voiceNotSupported: 'Microfonul nu este suportat in acest browser. Poti sa tastezi textul manual.',
      voicePermission: 'Trebuie sa permiti accesul la microfon pentru a folosi dictarea vocala.',
      voiceNoSpeech: 'Nu s-a detectat niciun sunet. Incearca din nou.',
      voiceError: 'Nu am putut porni dictarea vocala. Incearca din nou.',
