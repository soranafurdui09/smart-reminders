...
import { AlertTriangle, Calendar, CheckCircle2, Circle, Pill, SunMedium, Users } from 'lucide-react';
  ...
  return isMobile ? (
    uiMode === 'focus' ? (
      ...
      <FamilyHome
        ...
        taskItems={taskItems}
        listItems={listItems}
        inboxReminderItems={inboxReminderItems}
        copy={copy}
        taskBuckets={taskBuckets}
        taskPending={taskPending}
        handleToggleTask={handleToggleTask}
        inboxOverdue={inboxOverdue}
        inboxToday={inboxToday}
        inboxSoon={inboxSoon}
        inboxLater={inboxLater}
        reminderUndatedLimited={reminderUndatedLimited}
        reminderUndated={reminderUndated}
        mobileInboxLimit={mobileInboxLimit}
        setMobileInboxLimit={setMobileInboxLimit}
        locale={locale}
        ...
        setRememberMode={setRememberMode}
        ...
        todayOpenItems={todayOpenItems}
        soonItems={soonItems}
        visibleDoses={visibleDoses}
        nextDoseTileLabel={nextDoseTileLabel}
        overdueItems={overdueItems}
        overdueOldestLabel={overdueOldestLabel}
        focusItems={focusItems}
        nextUpActionsSheet={nextUpActionsSheet}
