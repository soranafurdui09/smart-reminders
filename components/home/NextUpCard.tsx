  ...
  return (
    <div className={`next-reminder-card ${toneClassName} relative overflow-hidden rounded-[22px] border border-white/10 bg-white/[0.06] shadow-[0_18px_55px_rgba(0,0,0,0.55)] backdrop-blur-[18px] p-3 before:content-[''] before:absolute before:top-[-34px] before:right-[-70px] before:w-[260px] before:h-[170px] before:bg-[radial-gradient(circle_at_35%_35%,rgba(214,161,74,0.40)_0%,rgba(214,161,74,0.18)_38%,rgba(214,161,74,0.00)_72%)] before:blur-[10px] before:opacity-95 before:pointer-events-none after:content-[''] after:absolute after:top-0 after:left-[14px] after:right-[14px] after:h-px after:bg-[linear-gradient(90deg,rgba(214,161,74,0)_0%,rgba(214,161,74,0.55)_45%,rgba(214,161,74,0)_100%)] after:opacity-60 after:pointer-events-none`}>
      <div className="next-reminder-content">
        ...
        <div className="next-reminder-label text-[11px] tracking-[0.18em] uppercase text-white/60">{title}</div>
        {onMoreActions ? (
          <button
            type="button"
            className="next-reminder-more w-9 h-9 rounded-full bg-white/5 border border-white/10 flex items-center justify-center"
        ...
        <div className="mt-1 space-y-1">
          <div className="flex items-center justify-between gap-1.5">
            <div className="next-reminder-title line-clamp-2 mt-1 text-[clamp(1.2rem,3.6vw,1.35rem)] leading-[1.12] font-semibold text-white">{taskTitle}</div>
            {action ? (
              <form action={markDone}>
                ...
                <ActionSubmitButton
                  className="next-reminder-primary rounded-full px-4 py-2 text-[0.88rem] bg-[#4D7DFF] text-white font-semibold shadow-[0_10px_24px_rgba(77,125,255,0.35)]"
                  type="submit"
          ...
          <div className="next-reminder-time mt-1 text-[clamp(0.82rem,2.8vw,0.92rem)] text-white/70">{timeLabel}</div>
          <div className="flex flex-wrap items-center justify-between gap-1.5">
            <div className="flex flex-wrap items-center gap-2">
              {badge ? (
                <span
                  className="next-reminder-pill px-2 py-0.5 rounded-full text-[0.7rem] border border-white/12 bg-white/5 text-white/70 border-emerald-400/35 text-emerald-200/90 bg-emerald-400/10"
              ...
              {tone === 'overdue' ? (
                <span className="next-reminder-overdue px-2 py-0.5 rounded-full text-[0.7rem] border border-white/12 bg-white/5 text-white/70 border-amber-300/35 text-amber-200/90 bg-amber-300/10">
            ...
            {action ? (
              <div className="flex flex-wrap items-center gap-1.5">
                <form action={snoozeOccurrence}>
                  ...
                  <ActionSubmitButton className="next-reminder-secondary rounded-full px-3.5 py-1.25 text-[0.8rem] bg-white/6 border border-white/10 text-white/70" type="submit">
