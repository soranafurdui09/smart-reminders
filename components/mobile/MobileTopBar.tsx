...
export default function MobileTopBar({
  ...
  return (
    <div className="safe-top sticky top-0 z-40 border-b border-border/70 bg-[color:var(--bg-base)]/95 backdrop-blur">
      <div className="page-wrap flex items-center justify-between gap-3 py-3">
        ...
        <div className="flex items-center gap-2">
          <Link
            href="/app?tab=inbox"
            className="premium-icon-btn h-9 w-9 text-textInv"
            aria-label="Căutare"
          >
